...
page_ranges_2015 = {
    ...
    "unicredt_2015.pdf": range(314, 462),  # 13370.ar.en.2015.pdf
...
page_ranges_2016 = {
    ...
    "unicredt_2016.pdf": range(282, 438),         # 13370.ar.en.2016.pdf
...
page_ranges_2017 = {
    ...
    "unicredt_2017.pdf": range(178, 262),  # 13370.ar.en.2017.pdf
...
page_ranges_2018 = {
    ...
    "unicredt_2018.pdf": range(279, 418),  # 13370.ar.en.2018.pdf
...
page_ranges_2019 = {
    ...
    "unicredt_2019.pdf": range(250, 381),  # 13370.ar.en.2019.pdf
...
page_ranges_2020 = {
    ...
    "nordea_2020.pdf": range(102, 136),  # nordea_2020.pdf (as in original)
    ...
    "unicredt_2020.pdf": range(263, 400),  # 13370.ar.en.2020.pdf
...
page_ranges_2021 = {
    ...
    "unicredt_2021.pdf": range(264, 399),  # 13370.ar.en.2020.pdf
    "Santander_2021.pdf": range(429, 514),
    "swedbank_2021.pdf": range(78, 107),  # 2016 Annual Report.pdf
...
page_ranges_2022 = {
    ...
    "unicredt_2022.pdf": range(263, 400),  # 13370.ar.en.2020.pdf
    "Santander_2022.pdf": range(418, 503),
    "swedbank_2022.pdf": range(79, 110),  # 2016 Annual Report.pdf
...
page_ranges_2023 = {
    ...
    "unicredt_2023.pdf": range(398, 570),  # 13370.ar.en.2020.pdf
    "Santander_2023.pdf": range(451, 513),
    "swedbank_2023.pdf": range(84, 115),  # 2016 Annual Report.pdf
...
page_ranges_2024 = {
    ...
    "swedbank_2024.pdf": range(242, 273),  # swedbank-ab_2024.pdf
    ...
    "unicredt_2024.pdf": range(525, 690),  # 13370.ar.en.2020.pdf
    "CreditAgricole_2024.pdf": range(15, 22),  # was Cr%c3%a9dit_Agricole_...(Mar-30-2015).pdf
